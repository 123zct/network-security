...
public class VServer {
    ...
    public void send() {
        ...
        contentArea.append("服务器明文：" + txt_message.getText() + "\r\n");
        try{
        contentArea.append("服务器密文：" + MD5.encodeBase64(MD5.encryptionMD5(txt_message.getText()))+ "\r\n");
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    public void sendServerMessage(String message) {
        ...
        for (int i = clients.size() - 1; i >= 0; i--) {
            ...
            try {
                clients.get(i).getWriter().println("服务器：" + MD5.encodeBase64(MD5.encryptionMD5(message)));
            }catch(Exception e){
                e.printStackTrace();
            }
    ...
    class ClientThread extends Thread {
            ...
            while (true) {
                ...
                try {
...

                    {
                        ...
                        dispatcherMessage(message,message);// 转发消息
                    }
        ...
        public void dispatcherMessage(String message,String message1) {
            ...
            try {
                ...
                message1 = source + ":" +MD5.encodeBase64(MD5.encryptionMD5(content));
            }catch(Exception e){
                e.printStackTrace();

            }
            contentArea.append(message + "\r\n");
            contentArea.append(message1 + "\r\n");

...
public class DES {
	String EncryResult="";
	String DecryResult="";
	public String Encryption(String str,String password)//加密
	{
		int len=str.length();
		int a=len/8;
		int b=len%8;
	...
	public String Decryption(String str,String password)//解密
	{
		int len=str.length();
		int a=len/64;
	...
	public static void main(String args[]) {
		...
		System.out.println("解密结果为："+des.Decryption(a, password));

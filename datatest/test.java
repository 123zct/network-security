...
public class test{
    ...
    {    
    	...
    	String userName="LAPTOP-EVPM8DRM";
    	String userPwd="";
    	try
    	{
    ...
    public static int Database(int IDc,String Secret) throws SQLException
    {
	    ...
	    String query = "create table ClientData(IDc int,Secret NCHAR(50),Hashkey varchar(50))";// 创建表SQL语句 
